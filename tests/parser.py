...
class ParseTestCase(unittest.TestCase):
    ...
    def test_bms(self):
        ...
        self.assertTrue(fgd)
        self.assertEqual(829, len(fgd.entities))

    def test_cs(self):
        fgd = FgdParse('tests/fgds/cs/halflife-cs.fgd')
        self.assertTrue(fgd)
        self.assertEqual(100, len(fgd.entities))

    def test_csgo(self):
        fgd = FgdParse('tests/fgds/csgo/csgo.fgd')
        self.assertTrue(fgd)
        self.assertEqual(460, len(fgd.entities))
    ...
    def test_portal2(self):
        ...
        self.assertTrue(fgd)
        self.assertEqual(1122, len(fgd.entities))

    def test_ricochet(self):
        fgd = FgdParse('tests/fgds/ricochet/ricochet.fgd')
        self.assertTrue(fgd)
        self.assertEqual(10, len(fgd.entities))

    def test_swarm(self):
        fgd = FgdParse('tests/fgds/swarm/swarm.fgd')
        self.assertTrue(fgd)
        self.assertEqual(389, len(fgd.entities))

    def test_tf(self):
        fgd = FgdParse('tests/fgds/tf/tf.fgd')
        self.assertTrue(fgd)
        self.assertEqual(442, len(fgd.entities))

    def test_tfc(self):
        fgd = FgdParse('tests/fgds/tfc/tf15f.fgd')
        self.assertTrue(fgd)
        self.assertEqual(52, len(fgd.entities))
